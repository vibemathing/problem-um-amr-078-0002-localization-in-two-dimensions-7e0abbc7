...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-amr-078-0002-localization-in-two-dimensions-7e0abbc7-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/AMR-078-0002"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-amr-078-0002-localization-in-two-dimensions-7e0abbc7-v1",
      "problem_contract_sha256": "008a9a8223d4cc056cf0932ea9dc1a70e9f6c73df3f7c1b04bc7eab1f39d992e",
      "problem_id": "problem:um-amr-078-0002-localization-in-two-dimensions-7e0abbc7",
      "route_id": "route:um-amr-078-0002-localization-in-two-dimensions-7e0abbc7-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-amr-078-0002-localization-in-two-dimensions-7e0abbc7-source-fidelity-01",
      "graph_id": "graph:um-amr-078-0002-localization-in-two-dimensions-7e0abbc7-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-amr-078-0002-localization-in-two-dimensions-7e0abbc7-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-amr-078-0002-localization-in-two-dimensions-7e0abbc7-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Prove that the spectrum of the Anderson model in dimension $\\nu=2$ is dense pure point."
          },
          "statement_sha256": "7a61129c794defc530a67a09b7599f1b3762f366e352b76e6bd456d9c7d5eded"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-amr-078-0002-localization-in-two-dimensions-7e0abbc7-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-amr-078-0002-localization-in-two-dimensions-7e0abbc7-root",
      "route_id": "route:um-amr-078-0002-localization-in-two-dimensions-7e0abbc7-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "domain": {
      "description": "Source-native Mathematical Physics problem. Mathematical objects and notation are exactly those explicitly present in the frozen source statement.",
      "objects": [
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-078-0002-cc58dc2c0ac7",
        "url": "https://www.unsolvedmath.com/problems/AMR-078-0002"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
